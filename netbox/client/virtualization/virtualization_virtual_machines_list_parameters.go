...
func (o *VirtualizationVirtualMachinesListParams) WithRegionID(regionID *float64) *VirtualizationVirtualMachinesListParams {
	o.SetRegionID(regionID)
	return o
}

// SetRegionID adds the regionId to the virtualization virtual machines list params
func (o *VirtualizationVirtualMachinesListParams) SetRegionID(regionID *float64) {
	o.RegionID = regionID
}

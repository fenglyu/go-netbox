...
/*IpamPrefixesAvailablePrefixesCreateBadRequest handles this case with default header values.
...
func (o *IpamPrefixesAvailablePrefixesCreateBadRequest) GetPayload() *models.Error {
	return o.Payload
}

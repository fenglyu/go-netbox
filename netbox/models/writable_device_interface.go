...
// ContextValidate validate this writable device interface based on the context it is used
func (m *WritableDeviceInterface) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WritableDeviceInterface) contextValidateCable(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableDeviceInterface) contextValidateConnectedEndpoint(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *WritableDeviceInterface) contextValidateConnectedEndpointType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableDeviceInterface) contextValidateCountIpaddresses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WritableDeviceInterface) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
